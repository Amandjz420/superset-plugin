...
export default function TableSamagraChart<D extends DataRecord = DataRecord>(
  ...
  const [crossFilterKeys, setCrossFilterKeys] = useState({});
  ...
  const toggleFilter = useCallback(
    function toggleFilter(key: string, val: DataRecordValue) {
      ...
      if (crossFilterKeys[key]) {
        let value = '';
        if (crossFilterKeys[key] !== val) {
          // @ts-ignore
          value = val.toString();
          setCrossFilterKeys({ ...crossFilterKeys, [key]: value });
        } else {
          const resultFilters = { ...crossFilterKeys, [key]: value };
          delete resultFilters[key];
          setCrossFilterKeys(resultFilters);
        }
      } else {
        setCrossFilterKeys({ ...crossFilterKeys, [key]: val });
      }
