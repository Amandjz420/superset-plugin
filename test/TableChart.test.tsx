...
import TableSamagraChart from '../src/TableSamagraChart';
...
describe('plugin-chart-table', () => {
  ...
  describe('TableSamagraChart', () => {
    let wrap: CommonWrapper; // the ReactDataTable wrapper
    let tree: Cheerio;

    it('render basic data', () => {
      wrap = mount(
        <TableSamagraChart {...transformProps(testData.basic)} sticky={false} />,
      );
    ...
    it('render advanced data', () => {
      wrap = mount(
        <TableSamagraChart {...transformProps(testData.advanced)} sticky={false} />,
      );
      tree = wrap.render();
